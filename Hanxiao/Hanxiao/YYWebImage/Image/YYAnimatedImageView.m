...
//    if ([image isMemberOfClass:[YYImage class]]) {
//        if (((YYImage*)image).animatedImageData != nil && self.scale != 0) {
//            image = [YYImage imageWithData:((YYImage*)image).animatedImageData scale:self.scale];
//        }
//    }
...
//        UIImage *dimage = image;
//        image = [UIImage imageWithCIImage:dimage.CIImage scale:self.scale orientation:dimage.imageOrientation];
//    }else if([image isKindOfClass:[NSArray class]]){
//        NSMutableArray *images = @[].mutableCopy;
//        for (UIImage *image_item in image) {
//            UIImage *nimage = [UIImage imageWithCIImage:image_item.CIImage scale:self.scale orientation:image_item.imageOrientation];
