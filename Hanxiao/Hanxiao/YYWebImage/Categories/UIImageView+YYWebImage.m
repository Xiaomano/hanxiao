...
-(void)yy_setImageWithURLString:(NSString *)imageUrlString placeholder:(UIImage *)placeholder
{
...
//            newSentinel = [setter setOperationWithSentinel:sentinel url:fullImageURL options:options manager:manager progress:_progress transform:transform completion:_completion];
