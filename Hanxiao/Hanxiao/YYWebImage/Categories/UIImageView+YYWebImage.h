...
/**
 ...
 @param imageURLString    The image urlString (remote or local file path).
 @param placeholder The image to be set initially, until the image request finishes.

 
*/
- (void)yy_setImageWithURLString:(NSString *)imageUrlString placeholder:(nullable UIImage *)placeholder;
